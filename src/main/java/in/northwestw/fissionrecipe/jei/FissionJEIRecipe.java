...
public class FissionJEIRecipe extends FissionRecipe {
    ...
    public FissionJEIRecipe(FissionRecipe recipe, ChemicalStack output, List<FluidStack> inputs) {
    ...
    public FissionJEIRecipe(FissionRecipe recipe, List<ChemicalStack> inputs, ChemicalStack output) {
        super(recipe.getInput(), recipe.getOutputRaw(), recipe.getHeat());
